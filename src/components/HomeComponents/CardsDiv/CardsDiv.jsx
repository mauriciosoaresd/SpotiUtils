                ...
                <>
                    <div className="card" style={{ width: 23 + 'rem' }}>
                        <Link to={user.loggedIn ? '/convert-playlists' : '/'}>
                            <img src={require('../../../assets/images/photo-1515010137531-66995c7f40e6.jpeg')} className="card-img-top" alt="Conversion Cover"></img>
                    ...
                    <div className="card" style={{ width: 23 + 'rem' }}>
                        <Link to={user.loggedIn ? '/random-playlists' : '/'}>
                            <img src={require('../../../assets/images/concert.jpg')} className="card-img-top" alt="Random Song Cover"></img>
                            <div className="card-body">
                    ...
                    <div className="card" style={{ width: 23 + 'rem' }}>
                        <Link to={user.loggedIn ? '/my-stats' : '/'}>
                            <img src={require('../../../assets/images/photo-1526628953301-3e589a6a8b74.jpeg')} className="card-img-top" alt="Stats Cover"></img>
                            <div className="card-body">
